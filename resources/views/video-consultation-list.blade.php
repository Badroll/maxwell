...
<x-layout-app withNavbar withFooter withBottomNavbar>
	<div x-data="{ isEmpty: false, openModal: false }">
		<div class="max-w-8xl mx-auto px-5 md:px-8 lg:px-16">
			<div class="pt-6 md:pt-24 block md:flex items-center">
				...
				<div class="mt-4 md:mt-0">
					<button @click="openModal = true" class="block w-full md:w-auto py-2 px-4 bg-klinik-primary text-white rounded-full font-bold btn-focus-primary text-sm text-center">
						<div>
			...
			<div class="mt-6 mb-20" x-show="isEmpty === false">
				...
				{{-- tampilan desktop --}}
				<table class="table-fixed w-full hidden md:table">
					<thead>
						<tr class="border-t border-b border-gray-200">
							<th class="text-left py-5 px-2 w-4/12">Tanggal Konsultasi</th>
							<th class="py-5 px-2 text-left w-5/12">Status Konsultasi</th>
							<th class="py-5 px-2 w-3/12"></th>
						</tr>
					</thead>
					<tbody>
						<tr class="border-b border-gray-200">
							<td class="text-left py-3 px-2 text-sm font-bold">20 Juli 2020 - 13:15</td>
							<td class="py-3 px-2 text-green-300 font-bold text-sm">RESEP TERSEDIA</td>
							<td class="py-3 px-2">
								<div class="grid grid-cols-2 gap-4">
									<div class="w-full">
										<a href="/video-consultation-detail-ready" class="border-2 border-klinik-primary text-sm text-klinik-primary rounded-full py-1.5 lg:py-2 w-full font-semibold focus:outline-none block text-center">
											DETAIL
										</a>
									</div>
									<div class="w-full">
						...
						<tr class="border-b border-gray-200">
							...
							<td class="py-3 px-2">
								<div class="grid grid-cols-2 gap-4">
									<div class="w-full">
										<a href="/video-consultation-detail-waiting" class="border-2 border-klinik-primary text-sm text-klinik-primary rounded-full py-1.5 lg:py-2 w-full font-semibold focus:outline-none block text-center">
											DETAIL
										</a>
									</div>
						...
						<tr class="border-b border-gray-200">
							...
							<td class="py-3 px-2">
								<div class="grid grid-cols-2 gap-4">
									<div class="w-full">
										<a href="/video-consultation-detail-done" class="border-2 border-klinik-primary text-sm text-klinik-primary rounded-full py-1.5 lg:py-2 w-full font-semibold focus:outline-none block text-center">
											DETAIL
										</a>
									</div>
									<div class="w-full">
				...
				<div class="block md:hidden shadow-card-pc rounded-lg divide-y">
					...
					<div class="px-6 py-8">
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							<div class="w-full">
								<a href="/video-consultation-detail-ready" class="border-2 block text-center border-klinik-primary text-sm text-klinik-primary rounded-full py-1.5 lg:py-2 w-full font-semibold focus:outline-none">
									DETAIL
								</a>
							</div>
							<div class="w-full">
					...
					<div class="px-6 py-8">
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							<div class="w-full col-span-2 flex justify-center">
								<a href="/video-consultation-detail-waiting" class="border-2 text-center w-full border-klinik-primary text-sm text-klinik-primary rounded-full py-1.5 lg:py-2 font-semibold focus:outline-none">
									DETAIL
								</a>
							</div>
						</div>
					...
					<div class="px-6 py-8">
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							<div class="w-full col-span-2 flex justify-center">
								<a href="/video-consultation-detail-done" class="border-2 text-center w-full border-klinik-primary text-sm text-klinik-primary rounded-full py-1.5 lg:py-2 font-semibold focus:outline-none">
									DETAIL
								</a>
							</div>
						</div>
								...
								<div class="w-full mt-4 text-center md:mt-0">
										...
										<div class="my-4">
												<p class="text-sm text-gray-500">
														Anda akan menggunakan 1 token untuk memulai layanan Live Video Consultation. <br>Tekan tombol LANJUT untuk memulai Live Video Consultation.
												</p>
										</div>
										<div class="my-4 max-w-full md:max-w-sm mx-auto space-y-1">
												...
												<div class="flex items-center justify-between p-3 rounded-lg bg-klinik-primary-light text-white">
													<div class="font-bold text-sm">Token untuk Live Video Consultation</div>
										...
										<div class="p-4 rounded-lg bg-klinik-blue-light max-w-md mx-auto text-sm my-4">
											Dengan menekan tombol LANJUT, Anda dianggap telah membaca dan menyetujui syarat dan ketentuan layanan Live Video Consultation.
										</div>
								</div>
							</div>
							<div class="mt-5 md:mt-4 md:flex justify-center md:flex-row-reverse w-full">
								<a href="/create-appointment-video-date">
