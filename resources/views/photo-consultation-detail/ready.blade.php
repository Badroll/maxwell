...
<x-layout-app withNavbar withFooter withBottomNavbar>
	<div class="max-w-8xl mx-auto" x-data="{ isReady: true }">
		...
		<div x-show="isReady === true">
			...
			<div class="px-5 md:px-8 lg:px-16">
				<div class="rounded-lg shadow-card-login hidden md:block">
					<div class="bg-klinik-green-light text-white py-1.5 text-center rounded-t-lg font-semibold text-xs md:text-base">
						RESEP TERSEDIA
					</div>
			...
			<div class="md:hidden">
				<div class="mt-5">
					...
					<div class="sticky p-4 bg-white" style="bottom: 60px;">
						<a
							href="/shopping-details"
							class="block text-center w-full px-5 py-2 bg-klinik-primary text-white rounded-full font-medium btn-focus-primary text-sm"
						>
							BELI OBAT
						</a>
					</div>
